...
public class Author extends TableImpl<AuthorRecord> {
     ...
     */
    public final TableField<AuthorRecord, String> FULL_NAME = createField(DSL.name("full_name"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.author.bio</code>.
     */
    public final TableField<AuthorRecord, String> BIO = createField(DSL.name("bio"), SQLDataType.CLOB, this, "");
